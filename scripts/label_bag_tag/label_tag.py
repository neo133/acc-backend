...
data_jsonx = json.load(open(
    "/home/frinksacckymore001/acc-backend/scripts/label_bag_tag/model_files/model_parameters.json",))
    ...
    if len_check:  # len(RTSP_LINKS) == len(vid_directions): ## len of all input arrays should be same
        ...
        try:
            ...
            model = torch.hub.load(
                f'{MISSED_TAG_PATH_BASE_URL}/label_bag_tag/yolov5-master', 'custom', source='local', path=BAG_MODEL_WEIGHT, force_reload=True)
